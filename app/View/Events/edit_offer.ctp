...
<div class="col-md-9 form-container">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 pad-left-4" style="width: 55%;">
                            <textarea class="form-control input-sm" id="event_description" title="Enter event description" name="data[data][event_description]" tabindex ='12' style="resize: vertical; margin-top: 0px; margin-bottom: 5px; height: 68px;" rows="3" required><?php echo $event['event_description'];?>
                            </textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    <label class="control-label col-sm-3 ml-0">Category</label>
                    <div class="col-sm-9" id='getcategory'>
                        <?php   
                        ...
                        ?>
                        <div class="col-sm-4 ml-0 p-0" style="margin-left: -12px; margin-right:12px;padding-left:5px;">
                        <?php
                            echo $this->Form->select(
                                ...
                                array('label'=>false,
                                    'multiple'=>'checkbox',
                                    'class'=>'checkbox-inline col-sm-4',
                                    'hiddenField' => false,
            ...
            <div class="row">
                <div class="col-sm-12"> 
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group date col-sm-6" id="start" style="padding-left: 12px;">
            ...
            <div class="row">
                <div class="col-sm-12">                        
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group date col-sm-6" id="end" style="padding-left: 12px;"> 
            ...
            <div class="row">
                <div class="form-group col-sm-12">
                    <label class="control-label col-sm-3 ml-0">Address</label> 
                    <div class="col-sm-7 pad-left-11">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 file-top">
                            <input type="file" name="data[photo][event_photo]" title="Upload a Photo Max. 1mb" id="event_photo" tabindex ='13'>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 file-top">
                            <input type="file" name="data[photo][organizer_logo]" title="Upload a Photo Max. 1mb" id="organizer_logo">
                            <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7 pad-left-4" style="width:56%;">
                            <textarea tabindex="26"  class="form-control input-sm" title="Message to be sent in Notification" name="data[data][notif_msg]" value="" style="resize: vertical; margin-top: 0px; margin-bottom: 5px; height: 68px;" rows="3" maxlength="140" id="notif_msg"><?php echo $event['notif_msg']; ?></textarea>   
                            <span class="help-block" style="float:left;">Characters Remaining &nbsp;<div id="notif_msg_char" style="float:right;">140</div></span>
                        </div>
                    </div>
                </div>
            </div>

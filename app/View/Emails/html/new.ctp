...
<title>CityBuzz | Unapproved</title>
<!--IMPORTANT: 
                                          ...
                                          <td class="wrapper vertical-middle" style="padding-top: 0;padding-bottom: 0;vertical-align: middle;">
                                                ...
                                                <tr>
                                                      <td class="vertical-middle" style="padding-top: 0;padding-bottom: 0;vertical-align: middle;">
                                                            <img src="http://cdn.shephertz.com/repository/files/364bdb81617f00608cfe04a26ac12d9362dbcd146dc885559143fdc125b1122f/a4ac896d1614eaa227d4bf6b88c10d632452f66e/logo1.png" style="width: 150px;height: 42px;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;max-width: 100%;float: left;clear: both;display: block;" border="0" alt="">
                                                      </td>
                                                </tr>
                                                </table>
                                                <!-- END: Logo -->
                  ...
                  <td>
                        ...
                        <tr>
                              <td class="wrapper last">
                                    <h4 style="font-size: 22px;display: block;margin: 5px 0 15px 0;">Hello Admin, New Event Has been Created </h4>
                                    <p>
                                           Please click the following URL to View and Approve it:
                                    </p>
                                    <!-- BEGIN: Note Panel -->
